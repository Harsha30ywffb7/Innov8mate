   ...
   // const project = projects.find(project => project.id === parseInt(match.params.id));
    ...
    return (
        <div className="max-w-xl mx-auto mt-8">
            ...
            <div className="mt-4">
                <p className="text-gray-600">Technologies: {projects[0].technologies.join(', ')}</p>
                <p className="text-gray-600">Members Required: {projects[0].membersRequired}</p>
            </div>
            <Link to="/collaboration/" className="text-blue-500 block mt-4">Back to Projects</Link>
        </div>
    );
}
